...
import CKT.Ministop.Apk.activities.OrderDetailsActivity;
...
public class OrdersAdapter extends RecyclerView.Adapter<OrdersAdapter.OrdersViewHolder> {
    ...
    public void onBindViewHolder(@NonNull OrdersViewHolder holder, int position) {
        ...
        holder.mOrderPaymentPriceTextView.setText(String.valueOf("VND" + new DecimalFormat().format(order.getTotalPriceAfterDiscount())));
