...
import CKT.Ministop.Apk.activities.CategoryProductsActivity;
 ...
 */
    ...
    public class CategoriesViewsHolder extends RecyclerView.ViewHolder {
        ...
        private void launchProductsActivity() {
            ...
            intent.putExtra(Intent.EXTRA_TEXT, mCategoriesList.get(getBindingAdapterPosition()).getCategoryName());
