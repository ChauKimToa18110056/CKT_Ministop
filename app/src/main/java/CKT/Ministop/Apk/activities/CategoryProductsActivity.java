...
import CKT.Ministop.Apk.adapters.ProductsAdapter;
...
public class CategoryProductsActivity extends AppCompatActivity {
    ...
    private void loadCategoryProducts() {
        ...
        ProductsViewModel productsViewModel = new ViewModelProvider(this, factory).get(ProductsViewModel.class);
...
/*
    private void loadCategoryProducts() {
        ProductsViewModelFactory factory = new ProductsViewModelFactory(mCategory);
        ProductsViewModel productsViewModel = new ViewModelProvider(this, ViewModelProvider.AndroidViewModelFactory.getInstance(this.getApplication())).get(ProductsViewModel.class);
        //ProductsViewModel productsViewModel = new ViewModelProvider(this).get(ProductsViewModel.class);

        productsViewModel.getCategoryProducts().observe(this, products -> {
            mProductsAdapter = new ProductsAdapter(CategoryProductsActivity.this, products);
            mProductsRecyclerView.setAdapter(mProductsAdapter);
        });
    }
